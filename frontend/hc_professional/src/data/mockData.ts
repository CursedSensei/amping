...
// All type definitions live in api_types/Patient.ts.
// The import below brings them into scope for use within this file (MOCK_PATIENTS,
// buildHeatmap). The re-exports keep all existing consumers compiling unchanged.

import type { DayStatus, HeatmapDay, Patient } from '../api_types/Patient';
